...
template<typename captype, typename tcaptype, typename flowtype>
inline
Energy<captype, tcaptype, flowtype>::Energy(int var_num_max, int edge_num_max, void (*err_function)(const char *))
...
Energy<captype, tcaptype, flowtype>::add_variable(int num) { return GraphT::add_node(num); }
